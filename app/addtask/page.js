...
try {
 ...
 if(data.status==false){toast.error("Validation Failed",{position:'top-center'})}
  ...
  return (
    <div className=" min-h-[58vh] grid grid-cols-12">
      <div className=" p-5 col-span-6 col-start-4">
        <h1 className="px-[35%]">Add your task here !!</h1>

      <Image src={undraw_writer_q06d} title="add task" style={{width:'15%'}}></Image>
        <form>
          <div className="mb-6">
            <label
              for="title"
          ...
          <div className="mb-6">
            ...
            name="status"
              type="text"
              id="Status" onChange={handleChange}
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            >
